...
export const metadata: Metadata = {
  ...
  description:
    'Guide for clients on how to submit case studies in the correct format'
}
        ...
        <div className="relative max-w-6xl mx-auto px-6 py-20">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="text-xl text-text-body leading-relaxed">
              Everything you need to know to submit case studies in the perfect
              format. Follow this guide to ensure your project gets the showcase
              it deserves.
            </p>
          </div>
        </div>
            ...
            <ul className="space-y-3 text-text-body">
              <li className="flex items-start">
                ...
                <span>
                  ...
                  <code className="bg-background-subtle px-2 py-1 rounded text-sm">
                    src/lib/caseStudies/case[ProjectName].ts
                  </code>
                </span>
              </li>
              <li className="flex items-start">
                <span className="w-2 h-2 bg-primary rounded-full mt-2 mr-3 flex-shrink-0"></span>
                <span>
                  <strong>Index entry:</strong> Update{' '}
                  <code className="bg-background-subtle px-2 py-1 rounded text-sm">
                    allCases.ts
                  </code>
                </span>
        ...
        <div className="mb-16">
          <div className="text-center mb-12">
            ...
            <p className="text-text-body text-lg">
              Follow these steps to submit your case study perfectly
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="relative">
              <div className="bg-background-section rounded-2xl p-8 shadow-lg border border-border h-full">
                <div className="absolute -top-4 left-8">
                  <div className="w-8 h-8 bg-gradient-to-r from-primary to-primary-dark rounded-full flex items-center justify-center text-background font-bold text-sm">
                    1
                  </div>
                </div>
                <h3 className="text-xl font-bold text-text-heading mb-4 mt-4">
                  Create Case File
                </h3>
                <p className="text-text-body mb-4">
                  Build your case study data structure with all required
                  sections.
                </p>
                <div className="bg-background-subtle rounded-lg p-4 text-sm">
                  <code className="text-text-heading">
                    case[YourProject].ts
                  </code>
                </div>
              </div>
            ...
            <div className="relative">
              <div className="bg-background-section rounded-2xl p-8 shadow-lg border border-border h-full">
                <div className="absolute -top-4 left-8">
                  <div className="w-8 h-8 bg-gradient-to-r from-primary-light to-primary rounded-full flex items-center justify-center text-background font-bold text-sm">
                    2
                  </div>
                </div>
                <h3 className="text-xl font-bold text-text-heading mb-4 mt-4">
                ...
                <p className="text-text-body mb-4">
                  Upload high-quality images and mockups to your project folder.
                </p>
                <div className="bg-background-subtle rounded-lg p-4 text-sm">
                  <code className="text-text-heading">
                    Hero, Mocks, Final images
                  </code>
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <div className="bg-background-section rounded-2xl p-8 shadow-lg border border-border h-full">
                <div className="absolute -top-4 left-8">
                  <div className="w-8 h-8 bg-gradient-to-r from-primary-dark to-primary rounded-full flex items-center justify-center text-background font-bold text-sm">
                    3
                  </div>
                </div>
                <h3 className="text-xl font-bold text-text-heading mb-4 mt-4">
                ...
                <p className="text-text-body mb-4">
                  Add your case to the main portfolio grid in allCases.ts.
                </p>
                <div className="bg-background-subtle rounded-lg p-4 text-sm">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              <div className="space-y-6">
                <div className="border-l-4 border-primary pl-6">
                  ...
                  <p className="text-text-body text-sm">
                    2-3 paragraphs explaining the challenge and why it needed
                    solving.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-light pl-6">
                  ...
                  <p className="text-text-body text-sm">
                    Context, roles, client info, deliverables, timeline, and
                    tools used.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-dark pl-6">
                  ...
                  <p className="text-text-body text-sm">
                    Clear lists of project objectives and obstacles encountered.
                  </p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                <div className="border-l-4 border-primary/70 pl-6">
                  ...
                  <p className="text-text-body text-sm">
                    Research process, key insights, quotes, and takeaways.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-light/70 pl-6">
                  ...
                  <p className="text-text-body text-sm">
                    Design approach with 4-6 key highlights and mockup
                    explanations.
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-dark/70 pl-6">
                  ...
                  <p className="text-text-body text-sm">
                    Outcomes, achievements, lessons learned, and client
                    feedback.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text-body text-sm">
                    Use Font Awesome icon names (e.g., 'FaBullseye')
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text-body text-sm">
                    All file paths absolute from /assets/
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-text-body text-sm">
                    Project slugs lowercase with hyphens
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-primary to-primary-dark rounded-2xl p-8 text-background border border-primary/20">
            ...
            <p className="text-background/80 mb-6">
              Have questions about the format or structure? Don't hesitate to
              reach out.
            </p>
            ...
            <p className="text-sm text-background/80 mt-4">
              Contact Sami with any questions
            </p>
          </div>
        </div>
      </div>
